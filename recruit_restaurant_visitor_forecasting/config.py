...
DAYS_SINCE_LAST_RECORD_COL = "days_since_last_visit_record"
GENRE_TE = "air_genre_te"
AREA_TE = "air_city_region_te"
RESERVE_AIR_COL = "air_reserves_sum"
RESERVE_HPG_COL = "hpg_reserves_sum"
RESERVE_AIR_NBR_COL = RESERVE_AIR_COL + "_neighbors"
RESERVE_HPG_NBR_COL = RESERVE_HPG_COL + "_neighbors"
TOTAL_RESERVES_COL = "total_reserves_sum"
TOTAL_RESERVES_NBR_COL = TOTAL_RESERVES_COL + "_neighbors"
DAYS_OF_WEEK = ["Mon", "Tue", "Wed", "Th", "Fri", "Sat", "Sun"]
OPEN_USUALLY_COL = "open_usually"
VISITORS_DOW_MEAN_COL = "visitors_dow_mean"
VISITORS_DOW_MEAN_NBR_COL = VISITORS_DOW_MEAN_COL + "_neighbors"
VISITORS_NBR_COL = VISITORS_COL + "_neighbors"
